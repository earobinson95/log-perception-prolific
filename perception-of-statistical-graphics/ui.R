  ...
  tabPanel("Demographics",
    ...
    fluidRow(
      column(id = "informed_consent_sidebar", width = 3,
          ...
          helpText(h6("If you are not from prolific, please enter any text or number above.")),
  ...
  tabPanel("Study 1: Lineups",
           ...
           fluidRow(
             column(id = "lineups_sidebar", width = 3,
                    ...
                    conditionalPanel(condition = "input.lineups_go",
                        uiOutput("lineups_sidebar_buttons1"),
                        uiOutput("lineups_sidebar_buttons2"),
                        uiOutput("lineups_sidebar_buttons3"),
