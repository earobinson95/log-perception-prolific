...
factorCols <- c("nick_name", "ip_address", "study_starttime", "prolific_id", "age", "gender", "academic_study", "computer_mouse", "recruitment", "pic_id", "param_value", "set", "test_param", "conf_level")
