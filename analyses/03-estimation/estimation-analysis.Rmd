...
estimation_model_data <- full_join(all_participants, estimation_feedback, by = joinCols) %>%
  ...
  select(participant_id, age, gender, academic_study, computer_mouse, recruitment, order, q_id, creature, dataset, scale, response, true_value, deviation, abs_deviation, calculation, scratchpad, qtext)
